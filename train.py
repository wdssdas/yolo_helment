...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_weights", '-pre', type=str, default="weights/darknet53.conv.74",
#    parser.add_argument("--pretrained_weights", '-pre', type=str,default="weights/yolov3.weights", 
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.checkpoint_interval == 0 or epoch == opt.epochs - 1:
            torch.save(model.state_dict(), f"checkpoints_pruning_0.001/yolov3_ckpt_{epoch}_{timestamp}.pth")
            model.save_darknet_weights("checkpoints_pruning_0.001/pruning_yolov3.weights")
