...
class opt():
    model_def = "config/prune_0.3_prune_0.3_yolov3-hand.cfg"
#    model_def = "config/yolov3-hand.cfg"    
    data_config = "config/oxfordhand.data"
#    model = 'checkpoints/yolov3.weights'
    model = 'checkpoints_pruning_0.001/yolov3_ckpt_99_11221241.pth'
...
eval_model = lambda model:evaluate(model, path=valid_path, iou_thres=0.5, conf_thres=0.001,
    nms_thres=0.3, img_size=model.img_size, batch_size=8)
...
compact_model.save_darknet_weights("checkpoints_pruning_0.001/pruning_yolov3.weights")
