# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 10:32:05 2019
...
class WeightSaver(object):
    ...
    def __init__(self,h5_path,output_path):
        ...
        self.model = yolo_body(image_input, 9//3, 2)
#        self.model = load_model(h5_path,custom_objects={'yolo_head':yolo_head,'tf':tf,'box_iou':box_iou,'lambda':<lambda>})
